...
<?php
		...
		//Check for the existence of an associated .xml file for the selected device and parses and displays the required info if found
		...
		foreach ($xml->host->ports->port as $discoveredPorts){
			//parses and displays open port details of selected host
