...
<li>Scan mode, the word 'SCAN' will be displayed on the screen, when in this mode the device is running a scan or processing something.  Once it ends you might have to refresh the page to see the results.</li></ul>
        ...
        <a href="command.php?cmd=quickScan"><img src="images/button_quick-network-scan.png" alt="Perform a quick discover scan of the current subnet (fast scan)" title="Perform a quick discovery scan of the current subnet (fast scan)"></a></br>
